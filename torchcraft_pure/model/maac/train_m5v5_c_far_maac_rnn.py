...
from torchcraft_pure.model.maac.maac_rnn import MAAC
...
# test predator
agent1 = MAAC(name='marine0', agent_idx=0, state_dim=180, action_dim=10, training_agent_num=5,
              hidden_layer_sizes=[256, 64], actor_lr=1e-4, critic_lr=1e-4, batch_norm=True,
              replay_buffer_size=buffer_size)
agent2 = MAAC(name='marine1', agent_idx=1, state_dim=180, action_dim=10, training_agent_num=5,
              hidden_layer_sizes=[256, 64], actor_lr=1e-4, critic_lr=1e-4, batch_norm=True,
              replay_buffer_size=buffer_size)
agent3 = MAAC(name='marine2', agent_idx=2, state_dim=180, action_dim=10, training_agent_num=5,
              hidden_layer_sizes=[256, 64], actor_lr=1e-4, critic_lr=1e-4, batch_norm=True,
              replay_buffer_size=buffer_size)
agent4 = MAAC(name='marine3', agent_idx=3, state_dim=180, action_dim=10, training_agent_num=5,
              hidden_layer_sizes=[256, 64], actor_lr=1e-4, critic_lr=1e-4, batch_norm=True,
              replay_buffer_size=buffer_size)
agent5 = MAAC(name='marine4', agent_idx=4, state_dim=180, action_dim=10, training_agent_num=5,
              hidden_layer_sizes=[256, 64], actor_lr=1e-4, critic_lr=1e-4, batch_norm=True,
              replay_buffer_size=buffer_size)
...
if __name__ == '__main__':
    ...
    for episode in range(episodes):
        ...
        while not done:
            ...
            o_n_next, r_n, d_n, i_n = env.step(action_queue)
